...
<!-- Generated by `cargo xtask docs-gen`. Do not edit here; edit crates/ymir-nodes/docs/modifier.wave_exposure.md and regenerate. -->

# Wave Exposure

`modifier.wave_exposure` · Selectors
...
|---|---|---|---|---|---|---|
| Feature Radius (`feature_radius`) | float | [0, 10000] | 50 | m |  | no |
| Refraction Gain (`refraction_gain`) | float | [0, 4] | 0.5 |  |  | no |

## Layer contract

Emits `wave_energy` alongside the height layer.
